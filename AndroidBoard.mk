...
LOCAL_MODULE_TAGS := user
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_PATH := $(TARGET_OUT)/lib/modules/2.6.34-GoDmOdE-Darchshizz-OC
LOCAL_SRC_FILES := $(LOCAL_MODULE)
include $(BUILD_PREBUILT)
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/echo3:system/xbin/echo3 \
    $(LOCAL_PATH)/lights.msm7k.so:system/lib/hw/lights.msm7k.so \
    $(LOCAL_PATH)/sensors.heroc.so:system/lib/hw/sensors.heroc.so \
    $(LOCAL_PATH)/heroc-keypad.kcm.bin:system/usr/keychars/heroc-keypad.kcm.bin \
